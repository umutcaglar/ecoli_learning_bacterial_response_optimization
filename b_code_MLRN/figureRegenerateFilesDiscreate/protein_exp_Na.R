...
performanceDf %>%
  ...
  dplyr::mutate(experiment="protein_exp_Na")->winnerModelsForEachExp
...
write.csv(x = winnerModelsForEachExp, file = "../b_results/model_performance_protein_exp_Na.csv")
###*****************************
...
cowplot::save_plot(filename = "../b_figures/combinedParameters_protein_exp_Na.jpeg", plot = combinedParameters, ncol = 3, nrow = 2)
###*****************************
