...
performanceDf %>%
  ...
  dplyr::mutate(experiment="mRNA_exp_Na")->winnerModelsForEachExp
...
write.csv(x = winnerModelsForEachExp, file = "../b_results/model_performance_mRNA_exp_Na.csv")
###*****************************
...
cowplot::save_plot(filename = "../b_figures/combinedParameters_mRNA_exp_Na.jpeg", plot = combinedParameters, ncol = 3, nrow = 2)
###*****************************
