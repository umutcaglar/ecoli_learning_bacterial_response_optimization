...
timeStampFile %>%
  ...
  dplyr::filter(testConditions==paste0(c("Na_mM_Levels"),collapse = "_"))->chosenDataSetInfo
...
performanceDf %>%
  ...
  dplyr::mutate(experiment="protein_sta_Na")->winnerModelsForEachExp
...
write.csv(x = winnerModelsForEachExp, file = "../b_results/model_performance_protein_sta_Na.csv")
###*****************************
...
cowplot::save_plot(filename = "../b_figures/combinedParameters_protein_sta_Na.jpeg", plot = combinedParameters, ncol = 3, nrow = 2)
###*****************************
...
#                      filename = paste0("../b_figures/fig_protein_exp_Na.pdf"),
...
#                      filename = paste0("../b_figures/fig_withLegend_protein_exp_Na.pdf"),
#                      base_aspect_ratio=1.333, base_height = 6, 
#                      units = "in", useDingbats=FALSE, limitsize=FALSE,
#                      ncol = 1.4, nrow=1.2)
#   
...
#        file = paste0("../b_figures/fig_obj_protein_exp_Na.Rda"))
#   ###*****************************
# }
