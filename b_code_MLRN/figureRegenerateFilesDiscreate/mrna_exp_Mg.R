...
performanceDf %>%
  ...
  dplyr::mutate(experiment="mRNA_exp_Mg")->winnerModelsForEachExp
...
write.csv(x = winnerModelsForEachExp, file = "../b_results/model_performance_mRNA_exp_Mg.csv")
###*****************************
...
cowplot::save_plot(filename = "../b_figures/combinedParameters_mRNA_exp_Mg.jpeg", plot = combinedParameters, ncol = 3, nrow = 2)
###*****************************
...
#                      filename = paste0("../b_figures/fig_mRNA_exp_Mg.pdf"),
...
#                      filename = paste0("../b_figures/fig_withLegend_mRNA_exp_Mg.pdf"),
#                      base_aspect_ratio=1.333, base_height = 6, 
#                      units = "in", useDingbats=FALSE, limitsize=FALSE,
#                      ncol = 1.4, nrow=1.2)
#   
...
#        file = paste0("../b_figures/fig_obj_mRNA_exp_Mg.Rda"))
#   ###*****************************
# }
