...
testConditions=c("doublingTimeMinutes") # different combinations that we will look into
...
# SVM parameters
type_svmChoice="eps-regression" #Can be "eps-regression" but not "C-classification"
