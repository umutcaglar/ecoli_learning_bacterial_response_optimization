dataPrepearningFunction_wo_batch<-function(meta_df_Train, meta_df_Test, trainDataFrame, testDataFrame, 
                                  dataNameDF, dimReductionType)
{
  ###*****************************
  # Preperation of Data for PCA and PCoA
  # 1.) Correct batch effects (for out of house data no batch work)
